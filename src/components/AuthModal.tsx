      ...
      <div className="bg-white w-full max-w-[420px] rounded-[28px] shadow-2xl overflow-hidden border border-gray-100 flex flex-col relative p-6 sm:p-8 my-auto">
        ...
        <div className="grid grid-cols-1 gap-2.5 mb-6">
          ...
          <button
            ...
            className="w-full py-2.5 px-4 bg-[#24292F] hover:bg-[#24292F]/90 text-white border border-transparent rounded-xl font-bold text-sm flex items-center justify-center gap-2.5 transition-all cursor-pointer shadow-sm"
          >
